...
public final class OpaUtils {
    ...
    static ObjectAnimator getScaleObjectAnimator(View v, float factor, int duration, Interpolator interpolator) {
        ...
        PropertyValuesHolder[] valueHolder = new PropertyValuesHolder[2];
        valueHolder[0] = PropertyValuesHolder.ofFloat(View.SCALE_X, new float[]{factor});
        valueHolder[1] = PropertyValuesHolder.ofFloat(View.SCALE_Y, new float[]{factor});
        scaleAnimator = ObjectAnimator.ofPropertyValuesHolder(v, valueHolder);
